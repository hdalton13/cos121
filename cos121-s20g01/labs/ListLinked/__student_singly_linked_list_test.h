...
class Stu_Singly_Linked_List_Test : public CxxTest::TestSuite{
    ...
    void testDefaultConstructor() {
        // Create a default ListLinkedWrapper object and check vars
        ListLinkedWrapper<char> lst;
    ...
    void testParameterizedConstructor() {
        // Create a default ListLinkedWrapper object and check vars
        ListLinkedWrapper<char> lst(random()%100);
    ...
    void testAdd() {
        // Create a copied ListLinkedWrapper object and check vars
        ListLinkedWrapper<char> lst;
    ...
    void testCopyConstructor() {
        ...
        lst.__add('c');
        lst.__add('e');
        ListLinkedWrapper<char> lst2(lst);
    ...
    bool verifyEquivalent(ListLinkedWrapper<char>& lst, char items[], int size) {
        if(lst.isEmpty()) {
            if(size == 0) {
                return true;
            } else {
